 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://www.tangfan.org/user", wsdlLocation = "http://localhost:8085/soap/us?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://www.tangfan.org/user", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/soap/us?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://www.tangfan.org/user", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.tangfan.org/user", "UserServicePort"), UserService.class, features);
    }
