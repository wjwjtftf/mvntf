 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://impl.service.soap.tangfan.com/", wsdlLocation = "http://localhost:8082/my/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.soap.tangfan.com/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/my/?wsdl");
    ...
    public MyService getMyServiceImplPort() {
        return super.getPort(new QName("http://impl.service.soap.tangfan.com/", "MyServiceImplPort"), MyService.class);
    }
    ...
    public MyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.soap.tangfan.com/", "MyServiceImplPort"), MyService.class, features);
    }
